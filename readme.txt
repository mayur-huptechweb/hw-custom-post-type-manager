...
Custom Post Type Manager allows you to easily create and manage custom post types from the WordPress admin dashboard. Register a default "Books" post type and add your own custom post types using a simple settings page.
